...
dirs = os.listdir("C:/Users/Administrator/Desktop/10%VelocityData除信号/Intervention/VBT/")
for all_files in dirs:
    # 读取原始数据
    file = "C:/Users/Administrator/Desktop/10%VelocityData除信号/Intervention/VBT/" + all_files + ""
    ...
    title_png = title[:-4]
    filename = "C:/Users/Administrator/Desktop/10%速度阈值实验图片保存/" + title_png + ".png"
