...
dirs = os.listdir("C:/Users/Administrator/Desktop/10%VelocityData除信号/C&E/Concentric/MidTestConcentric/")

for all_files in dirs:
    # 读取原始数据
    file = "C:/Users/Administrator/Desktop/10%VelocityData除信号/C&E/Concentric/MidTestConcentric/" + all_files + ""
...
# 计算平均值和最大值
    ...
    if (division2.empty):
        ...
        division1.to_csv("C:\\Users\\Administrator\\Desktop\\10%VelocityData除信号\\C&E\\ConcentricResult\\PostTestConcentric\\" + title_csv + "-01.csv", index=False)
        ...
        division1.to_csv("C:\\Users\\Administrator\\Desktop\\10%VelocityData除信号\\C&E\\ConcentricResult\\PostTestConcentric\\" + title_csv + "-01.csv", index=False)
        division2.to_csv("C:\\Users\\Administrator\\Desktop\\10%VelocityData除信号\\C&E\\ConcentricResult\\PostTestConcentric\\" + title_csv + "-02.csv", index=False)
    else:
        # division1["Velocity_Mean"] = division1["Velocity"].mean()
        # division1["Velocity_Max"] = division1["Velocity"].max()
        # division2["Velocity_Mean"] = division2["Velocity"].mean()
        ...
        division1.to_csv("C:\\Users\\Administrator\\Desktop\\10%VelocityData除信号\\C&E\\ConcentricResult\\PostTestConcentric\\" + title_csv + "-01.csv", index=False)
        division2.to_csv("C:\\Users\\Administrator\\Desktop\\10%VelocityData除信号\\C&E\\ConcentricResult\\PostTestConcentric\\" + title_csv + "-02.csv", index=False)
        division3.to_csv("C:\\Users\\Administrator\\Desktop\\10%VelocityData除信号\\C&E\\ConcentricResult\\PostTestConcentric\\" + title_csv + "-03.csv", index=False)