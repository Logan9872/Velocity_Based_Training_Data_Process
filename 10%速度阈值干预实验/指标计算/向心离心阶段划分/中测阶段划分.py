...
dirs = os.listdir("C:/Users/Administrator/Desktop/10%VelocityData除信号/MidTest/")
for all_files in dirs:
    # 读取原始数据
    file = "C:/Users/Administrator/Desktop/10%VelocityData除信号/MidTest/" + all_files + ""
    #
    title = all_files[:38]  # 读取文件名
    title_png = title[:-4]
    filename = "C:/Users/Administrator/Desktop/测试数据绘制/中测/向心离心/" + title_png + ".png"
    # 读取速度和位置上数据
    ...
    OLC1.to_csv("C:\\Users\\Administrator\\Desktop\\10%VelocityData除信号\\C&E\\MidTestConcentric\\" + all_files + "", index=False)
    OLC2.to_csv("C:\\Users\\Administrator\\Desktop\\10%VelocityData除信号\\C&E\\MidTestEccentric\\" + all_files + "", index=False)
