...
for all_files in dirs:
    ...
    title_png = title[:-4]
    filename = "C:/Users/Administrator/Desktop/测试数据绘制/后测/向心离心/" + title_png + ".png"
    ...
    OLC1["Velocity"] = OLC1["Velocity"][OLC1["Velocity"] >= 0.03]  # 向心
    OLC2["Velocity"] = OLC2["Velocity"][OLC2["Velocity"] <= -0.03]  # 离心
    ...
    OLC1.to_csv("C:\\Users\\Administrator\\Desktop\\10%VelocityData除信号\\C&E\\PostTestConcentric\\" + all_files + "", index=False)
    OLC2.to_csv("C:\\Users\\Administrator\\Desktop\\10%VelocityData除信号\\C&E\\PostTestEccentric\\" + all_files + "", index=False)
