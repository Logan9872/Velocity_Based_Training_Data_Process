...
for all_files in dirs:
    ...
    plt.savefig("C:\\Users\\Administrator\\Desktop\\10%VelocityData除信号\\滤波后\\PreTestConcentric绘制\\速度\\" + title_csv + ".png")
    # plt.savefig("C:\\Users\\Administrator\\Desktop\\10%VelocityData除信号\\滤波后\\MidTestConcentric绘制\\速度\\" + title_csv + ".png")
    # plt.savefig("C:\\Users\\Administrator\\Desktop\\10%VelocityData除信号\\滤波后\\PostTestConcentric绘制\\速度\\" + title_csv + ".png")
    ...
    # VBT_data.to_csv("C:\\Users\\Administrator\\Desktop\\10%VelocityData除信号\\滤波后\\PostTestConcentric\\" + title_csv + ".csv", index=False)
