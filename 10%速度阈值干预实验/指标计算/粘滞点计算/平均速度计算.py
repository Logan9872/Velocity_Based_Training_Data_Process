...
for all_files in dirs:
    ...
    if len(sticky_regions) == 0:
        ...
        # 计算粘滞期内速度的平均值
        avg_vel = VBT_data.loc[combined_sticky_region[0]:combined_sticky_region[-1], 'Velocity'].mean()
        average_velocity.append(avg_vel)
...
sticky_region_csv["stick_average_velocity"] = average_velocity
