...
# 计算平均值和最大值
    ...
    if (division2.empty):
        ...
        division1["VBT_ Max"] = division1["VBT"].max()
        division1["OPTI_ Max"] = division1["OPTI"].max()
        division2["VBT_ Mean"] = division2["VBT"].mean()
        division2["OPTI_ Mean"] = division2["OPTI"].mean()
        division2["VBT_ Max"] = division2["VBT"].max()
        division2["OPTI_ Max"] = division2["OPTI"].max()
        division3["VBT_ Mean"] = division3["VBT"].mean()
        division3["OPTI_ Mean"] = division3["OPTI"].mean()
        division3["VBT_ Max"] = division3["VBT"].max()
        division3["OPTI_ Max"] = division3["OPTI"].max()
        division1.to_csv("C:\\Users\\Administrator\\Desktop\\meanV\\division\\" + all_files + "_1.csv", index=False)
