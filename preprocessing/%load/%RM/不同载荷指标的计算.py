...
dirs = os.listdir("C:/Users/Administrator/Desktop/LoadRank/%RM/OPTI_data_75")
for all_files in dirs:
    # 读取原始数据
    file = "C:/Users/Administrator/Desktop/LoadRank/%RM//OPTI_data_75/" + all_files + ""
    file_vbt = "C:/Users/Administrator/Desktop/LoadRank/%RM//VBT_data_75/" + all_files + ""
    # 读取Opti的原始数据
    ...
    # 保存成csv文件
    OLC.to_csv("C:\\Users\\Administrator\\Desktop\\OLC\\75%RM\\" + all_files + "", index=False)
    velocity_data.to_csv("C:\\Users\\Administrator\\Desktop\\LoadRank\\%RM\\pre_result\\75\\"+all_files+"", index=False)
