...
dirs = os.listdir("C:/Users/Administrator/Desktop/OLC/75%RM/")
for all_files in dirs:
    # 读取原始数据
    file = "C:/Users/Administrator/Desktop/OLC/75%RM/" + all_files + ""
    ...
    OLC1.to_csv("C:\\Users\\Administrator\\Desktop\\OLC\\%rm\\75%A\\" + all_files + "", index=False)
