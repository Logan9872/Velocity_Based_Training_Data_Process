...
dirs = os.listdir("C:/Users/Administrator/Desktop/LoadRank/pre_result_mid")
...
for all_files in dirs:
    file = "C:/Users/Administrator/Desktop/LoadRank/pre_result_mid/" + all_files + ""
...
# 当遍历完所有的数据后存为csv文件
    if (sum_data["filename"].shape[0] == 42):
        sum_data.to_csv("C:\\Users\\Administrator\\Desktop\\datapreprocess\\average_mid.csv", index=False)
