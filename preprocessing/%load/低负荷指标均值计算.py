...
dirs = os.listdir("C:/Users/Administrator/Desktop/LoadRank/pre_result_low")
...
for all_files in dirs:
    file = "C:/Users/Administrator/Desktop/LoadRank/pre_result_low/" + all_files + ""
...
# 当遍历完所有的数据后存为csv文件
    if (sum_data["filename"].shape[0] == 41):
        sum_data.to_csv("C:\\Users\\Administrator\\Desktop\\datapreprocess\\average_low.csv", index=False)
