...
dirs = os.listdir("C:/Users/Administrator/Desktop/LoadRank/OPTI_data_low")
for all_files in dirs:
    # 读取原始数据
    file = "C:/Users/Administrator/Desktop/LoadRank/OPTI_data_low/" + all_files + ""
    file_vbt = "C:/Users/Administrator/Desktop/LoadRank/VBT_data_low/" + all_files + ""
    # 读取Opti的原始数据
    ...
    OLC.to_csv("C:\\Users\\Administrator\\Desktop\\OLC\\low_load\\" + all_files + "", index=False)
    ...
    # 保存成csv文件
    velocity_data.to_csv("C:\\Users\\Administrator\\Desktop\\LoadRank\\pre_result_low\\"+all_files+"", index=False)
