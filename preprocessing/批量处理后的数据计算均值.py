...
dirs = os.listdir("C:/Users/Administrator/Desktop/DataPreprocess/pre_result")
...
for all_files in dirs:
    file = "C:/Users/Administrator/Desktop/DataPreprocess/pre_result/" + all_files + ""
...
# 将list转为字典
    sum_data_dist = {"filename": filename_sum, "MSE_sum": MSE_sum, "RMSE_sum": RMSE_sum, "MAE_sum": MAE_sum, "R2_sum": R2_sum, "ICC_sum": ICC_sum}
    sum_data = pd.DataFrame(sum_data_dist)
# 当遍历完所有的数据后存为csv文件
    if (sum_data["filename"].shape[0] == 104):
        sum_data.to_csv("C:\\Users\\Administrator\\Desktop\\datapreprocess\\average.csv", index=False)
